...
# (INPUT) sigma: An integer that applies to the gaussian blur
# (INPUT) window_size: An integer representing the side length of a square that defines the feature window
